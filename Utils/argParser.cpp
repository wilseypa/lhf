...
std::map<std::string, std::string> defaultMap = { {"dimensions","2"},{"iterations","250"},{"pipeline","distMatrix.neighGraph.rips.optPersistence"},{"inputFile","None"},{"outputFile","console"},{"epsilon","5"},{"debug","0"},{"complexType","indSimplexTree"},{"clusters","5"},{"preprocessor",""},{"upscale","false"},{"twist","false"}};
