...
template<typename nodeType>
void alphaComplex<nodeType>::buildBetaComplex(std::set<std::vector<unsigned>> dsimplexmesh, int npts, std::vector<std::vector<double>> inputData,double beta,std::string betaMode){
